            ...
            <section>
                <div class="flexCenter">
                    <form action="" name="form"
                        ...
                        <div class="flexCenter">
                        <input placeholder="Název domény" id="inputOrder" class="inputText" required type="text"
                               name="fname"><br>
                        </div>
                        <div class="flexCenter">
                        ...
                        <div class="flexCenter">
                        <input placeholder="Uživ. jméno" class="inputText" id="inputOrder" required type="text"
                               name="fusername"><br>
                        </div>
                        <div class="flexCenter">
                        <input placeholder="Heslo" class="inputText" id="inputOrder" required type="password"
                               name="fpassword"><br>
                        </div>
                        <div class="flexCenter">
                        <input placeholder="Potvrďte heslo" class="inputText" id="inputOrder" required type="password"
                               name="fpassword2"><br>
                        </div>
                        <div class="flexCenter">
                            <input class="inputSubmit" value="Vytvořit stránku" type="submit" name="orderFormSubmit">
                        </div>
                    </form>
                </div>
